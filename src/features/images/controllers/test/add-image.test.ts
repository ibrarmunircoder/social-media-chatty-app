...
describe('Add', () => {
  ...
  describe('profileImage', () => {
    it('should call image upload method', async () => {
      ...
      await AddImageController.profileImage(req, res);
  ...
  describe('backgroundImage', () => {
    it('should upload new image', async () => {
      ...
      await AddImageController.backgroundImage(req, res);
    ...
    it('should return bad request error', async () => {
      ...
      AddImageController.backgroundImage(req, res).catch((error: CustomError) => {
