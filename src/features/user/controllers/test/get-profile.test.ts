...
describe('Get', () => {
  ...
  describe('all', () => {
    it('should send success json response if users in cache', async () => {
      ...
      await GetUserProfileController.all(req, res);
  ...
  describe('profile', () => {
    it('should send success json response if user in cache', async () => {
      ...
      await GetUserProfileController.profile(req, res);
  ...
  describe('profileAndPosts', () => {
    it('should send success json response if user in cache', async () => {
      ...
      await GetUserProfileController.profileAndPosts(req, res);
      expect(UserCache.prototype.getUserFromCache).toHaveBeenCalledWith(`${req.currentUser?.userId}`);
  ...
  describe('profileByUserId', () => {
    it('should send success json response if user in cache', async () => {
      ...
      await GetUserProfileController.profileByUserId(req, res);
  ...
  describe('randomUserSuggestions', () => {
    it('should send success json response if user in cache', async () => {
      ...
      await GetUserProfileController.randomUserSuggestions(req, res);
