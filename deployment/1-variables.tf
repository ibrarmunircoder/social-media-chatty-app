...
variable "main_api_server_domain" {
  ...
  type        = string
  default     = "ibrarmunir.co" # Your backend domain you created a route53 zone for
}

variable "dev_api_server_domain" {
  description = "Dev API Server Domain"
  type        = string
  default     = "api.stage.ibrarmunir.co"
}

variable "ec2_iam_role_name" {
  description = "EC2 IAM Role Name"
  type        = string
  default     = "chattyapp-server-ec2-role" # Add a unique name
}

variable "ec2_iam_role_policy_name" {
  description = "EC2 IAM Role Policy Name"
  type        = string
  default     = "chattyapp-server-ec2-role-policy" # Add a unique name
}

variable "ec2_instance_profile_name" {
  description = "EC2 Instance Profile Name"
  type        = string
  default     = "chattyapp-server-ec2-instance-profile" # Add a unique name
}
...
variable "code_deploy_role_name" {
  ...
  type        = string
  default     = "chattyapp-codedeploy-role" # Add a unique name
}
...
variable "project" {
  ...
  type        = string
  default     = "chattapp-server" # You can use the name unique identifier created above
}
